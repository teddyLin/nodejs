...
function callDnode(req, res, next) {
var dnode = require(¡®dnode¡¯);
var dnodeClient = dnode.connect(7070, function (remote, conn) {
...
app.get(¡®/¡¯, callDnode, function(req, res, next){
res.send(¡°result:¡± + req.result);
//res.redirect(¡®/user/0¡ä);
});

app.listen(3000);
console.log(¡®Express app started on port 3000¡ä);